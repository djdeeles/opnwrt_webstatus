...
$_TRANSLATIONS["tr"] = array(
	...
	"password" => "Şifre",
	"upload" => "Yükle",
	"failed_upload" => "Dosya yüklenirken hata oluştu!",
	"failed_move" => "Dosya taşınırken hata oluştu!",
	"wrong_password" => "Yanlış şifre",
	"make_directory" => "Yeni Klasör yarat",
	"new_dir_failed" => "Klasör yaratılırken hata oluştu!",
	"chmod_dir_failed" => "Dosya hakları değiştirilirken hata oluştu!",
	"unable_to_read_dir" => "Klasör okunurken hata oluştu!",
	"location" => "Yer",
	"root" => "Kök",
	"log_file_permission_error" => "Günlük için yazma hakkı bulunmamaktadır.",
	"upload_not_allowed" => "Karşıya yükleme kapalı.",
	"upload_dir_not_writable" => "Bu klasörde yazma hakkı bulunmamaktadır.",
	"mobile_version" => "Mobil Görünüm",
	"standard_version" => "Standart Görünüm",
	"page_load_time" => "Sayfa %.2f ms'de yüklendi",
	"wrong_pass" => "Yanlış kullanıcı adı veya şifre",
