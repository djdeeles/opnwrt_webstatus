...
//
$_CONFIG['main_title'] = "aCC Dosya Y�neticisi";
...
//
$_CONFIG['session_name'] = "cetincone";
...
$_TRANSLATIONS["tr"] = array(
	"file_name" => "Dosya �smi",
	"size" => "Boyut",
	"last_changed" => "Son De�i�im",
	"total_used_space" => "Toplam Kullan�lan Alan",
	"free_space" => "Bo� Alan",
	"password" => "�ifre",
	"upload" => "Y�kle",
	"failed_upload" => "Dosya y�klenirken hata olu�tu!",
	"failed_move" => "Dosya ta��n�rken hata olu�tu!",
	"wrong_password" => "Yanl�� �ifre",
	"make_directory" => "Yeni Klas�r yarat",
	"new_dir_failed" => "Klas�r yarat�l�rken hata olu�tu!",
	"chmod_dir_failed" => "Dosya haklar� de�i�tirilirken hata olu�tu!",
	"unable_to_read_dir" => "Klas�r okunurken hata olu�tu!",
	"location" => "Yer",
	"root" => "K�k",
	"log_file_permission_error" => "The script does not have permissions to write the log file.",
	"upload_not_allowed" => "The script configuration does not allow uploading in this directory.",
	"upload_dir_not_writable" => "This directory does not have write permissions.",
	"mobile_version" => "Mobil G�r�n�m",
	"standard_version" => "Standart G�r�n�m",
	"page_load_time" => "Sayfa %.2f ms'de y�klendi",
	"wrong_pass" => "Yanl�� kullan�c� ad� veya �ifre",
	"username" => "Kullan�c� Ad�",
	"log_in" => "Giri�",
	"upload_type_not_allowed" => "Bu dosya t�r� y�klenemez!",
...
?> 
<a href="http://www.cetincone.com">�etin ��NE</a>
</div>
<!-- END: Info area -->
</body>
</html>
